...
def model_scores(
    ...
    """
    with mlflow.start_run(run_name="Score Run", nested=True) as score_run:

        print("RUN ID score:", score_run.info.run_id)

        mlflow.log_param("score_run_param", "score_run_value")
